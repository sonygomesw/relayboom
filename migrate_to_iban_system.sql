-- Migration vers système IBAN simple pour RelayBoom
...
-- 3. Modifier campaign_submissions pour le nouveau système
...
-- 4. Fonction pour créer automatiquement un paiement en attente
...
-- 6. Vue pour l'admin des paiements en attente
...
-- 9. Notification : fonction pour obtenir les stats de paiements
...
-- 10. Mettre à jour les soumissions existantes (si migration depuis Stripe Connect)
-- Cette partie peut être commentée si c'est un nouveau déploiement
/*
UPDATE campaign_submissions 
SET payment_status = 'pending'
WHERE payment_status = 'paid' AND stripe_transfer_id IS NOT NULL;
*/
