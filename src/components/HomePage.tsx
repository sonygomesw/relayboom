    ...
    <div className="min-h-screen bg-gradient-to-b from-white to-gray-50">
      ...
      <div id="comment-ca-marche" className="py-24 bg-white relative z-10">
        <div className="max-w-7xl mx-auto px-6 sm:px-8 lg:px-12">
          ...
          {/* CTA Section */}
          <div className="flex flex-col items-center mt-60 mb-60 relative z-30 space-y-6">
            <div className="inline-flex items-center px-6 py-3 bg-gray-50 rounded-full text-sm font-medium text-gray-600">
          ...
          <div className="mt-20 max-w-3xl mx-auto">
            <div className="bg-white rounded-3xl p-8 shadow-2xl border border-gray-200">
              <div className="text-center mb-8">
                <h3 className="text-3xl font-bold text-gray-900 mb-3">💰 Simulateur de gains</h3>
                <p className="text-gray-600 text-lg">Découvre combien tu peux gagner avec tes vues !</p>
              </div>
              ...
              <div className="space-y-8">
                <div>
                  ...
                  <input
                    ...
                    style={{
                      background: `linear-gradient(to right, #10B981 0%, #10B981 ${((viewsCount - 10000) / (5000000 - 10000)) * 100}%, #E5E7EB ${((viewsCount - 10000) / (5000000 - 10000)) * 100}%, #E5E7EB 100%)`,
                ...
                <div className="bg-gradient-to-r from-blue-50 to-green-50 rounded-2xl p-6 border border-blue-200">
                  <div className="text-center mb-4">
                    <h4 className="text-xl font-bold text-gray-900 mb-2">💡 Potentiel mensuel</h4>
                    <p className="text-gray-600">Si tu fais {Math.max(1, Math.round(viewsCount / 100000))} clips similaires par mois :</p>
                  </div>
                  <div className="text-center">
                    <div className="text-3xl font-bold text-blue-600">
                      {Math.round(viewsCount * 0.0001 * Math.max(1, Math.round(viewsCount / 100000)))}€/mois
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-green-50 rounded-2xl p-6 border border-green-200">
                  <div className="flex items-center justify-center gap-3 text-green-700">
                    ...
                    <span className="font-semibold">Clippers payés chaque semaine via Stripe</span>
                  </div>
                </div>
                ...
                <div className="text-center">
                  <button
                    ...
                    className="bg-gradient-to-r from-green-500 to-blue-500 hover:from-green-600 hover:to-blue-600 text-white px-10 py-4 rounded-2xl font-bold text-lg transition-all duration-200 transform hover:scale-105 shadow-lg"
                  >
                    Je veux gagner ça ! 🚀
                  </button>
                </div>
