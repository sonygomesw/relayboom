    ...
    <RoleProtectionOptimized allowedRoles={['creator']}>
      <div className="p-6">
        <div className="mb-8">
          ...
          <p className="text-gray-600">Welcome {profile?.pseudo || 'Creator'}! Here's an overview of your account.</p>
        </div>
        ...
        <div className="bg-white rounded-lg shadow p-6">
          ...
          <p className="text-gray-600">No missions yet. Create your first mission to get started!</p>
        </div>
      </div>
