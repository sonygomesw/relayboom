        ...
        <main className="p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 font-medium">{t.creator.missions.stats.totalMissions}</p>
                  <p className="text-2xl font-bold text-gray-900">{stats.totalMissions}</p>
                  <p className="text-xs text-green-600 flex items-center gap-1 mt-1">
                    <IconTarget className="w-3 h-3" />
                    {stats.activeMissions} {t.creator.missions.stats.active}
                  </p>
                </div>
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-600 font-medium">{t.creator.missions.stats.totalBudget}</p>
                  <p className="text-2xl font-bold text-gray-900">{formatCurrency(stats.totalBudget)}</p>
                  <p className="text-xs text-orange-600 flex items-center gap-1 mt-1">
                    <IconCoin className="w-3 h-3" />
                    {t.creator.missions.stats.investment}
                  </p>
                </div>
          ...
          <div className="bg-white rounded-xl border border-gray-200 p-6">
            <div className="flex items-center justify-between mb-6">
              <h2 className="text-xl font-bold text-gray-900">{t.creator.missions.title}</h2>
              <a
              ...
              >
                ...
                {t.creator.navigation.newMission}
              </a>
            </div>
