            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-8">
              {filteredMissions.map((mission) => {
                ...
                const budgetPercentage = Math.floor(Math.random() * 80) + 20; // Entre 20% et 100%
                   ...
                   <div 
                     key={mission.id}
                     className="bg-gray-900 rounded-xl overflow-hidden hover:bg-gray-800 transition-all duration-200 group flex flex-col h-96 relative border border-gray-700"
                   >
                       ...
                       <div className="text-right">
                         ...
                         {mission.featured && (
                           <div className="text-yellow-400 text-base mt-1">⭐</div>
                                         ...
                                         {/* Titre */}
                     <div className="px-8">
                       <h3 className="text-white font-bold text-lg mb-8 line-clamp-2 leading-tight">
                     ...
                     <div className="px-8 mb-10 flex-1 flex flex-col justify-center">
                       ...
                       <div className="flex items-center justify-between mb-4">
                         <span className="text-white font-bold text-lg">{budgetPercentage}%</span>
                         
                         {/* Plateformes */}
                         <div className="flex items-center gap-2">
                           {/* Instagram */}
                           <div className="w-6 h-6 rounded flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500">
                           ...
                           {/* TikTok */}
                           <div className="w-6 h-6 rounded flex items-center justify-center bg-black border border-gray-600">
                             <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-white">
