            ...
            <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 xl:grid-cols-6 gap-4">
              {filteredMissions.map((mission) => {
                ...
                return (
                  <div 
                    key={mission.id}
                    className="bg-gray-900 rounded-xl overflow-hidden hover:bg-gray-800 transition-all duration-200 group flex flex-col aspect-square relative border border-gray-700"
                  >
                    ...
                    <div className="flex items-start justify-between p-4">
                      ...
                      <div className="flex-shrink-0">
                        <img 
                          src={mission.creator_image || `https://ui-avatars.com/api/?name=${encodeURIComponent(mission.creator_name || 'User')}&background=0066CC&color=fff&size=48`}
                    ...
                    {/* Titre */}
                    <div className="px-4">
                      <h3 className="text-white font-bold text-sm mb-4 line-clamp-2 leading-tight">
                        {mission.title || 'Mission sans titre'}
                      </h3>
                    </div>

                    {/* Jauge de budget au milieu */}
                    <div className="px-4 mb-6 flex-1 flex flex-col justify-center">
                      ...
                      <div className="flex items-center justify-between">
                        <span className="text-white font-bold text-sm">{budgetPercentage}%</span>
                        
                        {/* Plateformes */}
                        <div className="flex items-center gap-1">
                          {/* Instagram */}
                          <div className="w-4 h-4 rounded flex items-center justify-center bg-gradient-to-r from-purple-500 to-pink-500">
                          ...
                          {/* TikTok */}
                          <div className="w-4 h-4 rounded flex items-center justify-center bg-black border border-gray-600">
                            <svg viewBox="0 0 24 24" className="w-2.5 h-2.5 fill-white">
